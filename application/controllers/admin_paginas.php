...
class Admin_paginas extends CI_Controller {
	...
	function __construct(){
		...
		$this->main_model_name = "m_admin_paginas";
		$this->photos_model_name = "m_admin_photos";

		$this->list_view = "back/v_content_paginas";
		$this->add_view = "back/v_content_paginas_add";
		$this->edit_view = "back/v_content_paginas_edit";
	...
	public function edit(){
		...
		$output["mod_title"] = "Editar Página";
