    ...
    <div class="page-header">
        ...
        <div class="row-fluid">
            ...
            <div class="btn-toolbar">
                ...
                <div class="btn-group text-right">
                    <a class="btn btn-danger btn-delete" href="#delete">
                    ...
                    <div class="tab-pane active" id="tab1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                <input type="hidden" id="idPhoto" value="<?php echo $row->idPhoto; ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="tags" placeholder="Etiquetas" value="<?php echo $row->tags; ?>" />
                            </div>
                        </div>
                    </div>
